...
\includegraphics[height=2.5cm]{mm2-08/01.png}

Sei $z+1:=r_1e^{i\theta_1}$, $z+1:=r_2e^{i\theta_2}$ bzw. $z =-1 + r_1e^{i\theta_1}$, $z =+1 + r_2e^{i\theta_2}$

\includegraphics[height=2.5cm]{mm2-08/02.png}
...
\includegraphics[height=2.5cm]{mm2-08/03.png}
...
\includegraphics[height=2.5cm]{mm2-08/04.png}
...
\includegraphics[height=2.5cm]{mm2-08/05.png}

$-\epsilon$: $\theta_1 = -\pi$, $\theta_2 = -\pi \implies \Im(f) = 0$

\includegraphics[height=2.5cm]{mm2-08/06.png}

II) $-1 < x < 1$: $+\epsilon$: $\theta_1 = 0$, $\theta_2 = \pi \implies \Im(f) = -\pi$

\includegraphics[height=2.5cm]{mm2-08/07.png}

$-\epsilon$: $\theta_1 = 0$, $\theta_2 = -\pi \implies \Im(f)=+\pi \neq -\pi$

\includegraphics[height=2.5cm]{mm2-08/08.png}

III) $x > +1$: $\pm\epsilon \implies \Im(f) = 0$ (analog zu I))


\includegraphics[height=2.5cm]{mm2-08/09.png}
...
\includegraphics[height=2.5cm]{mm2-08/10.png}
...
\includegraphics[height=2.5cm]{mm2-08/11.png}
...
$\implies \oint\limits_{C} \frac{\sqrt{z}}{1+z^2} dz = 2   \int\limits_{0}^{\infty} \frac{\sqrt{x}}{1+^2} dx + 0$
