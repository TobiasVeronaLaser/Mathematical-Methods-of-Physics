...
\begin{figure}[htb!]
 \centering
 \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-01-darstellung_in_2d_ebene.png}
\end{figure}
...
\begin{itemize}
    ...
    \begin{figure}[htb!]
        \centering
        \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-02-darstellung als vektorfeld.png}
    \end{figure}

    \item $(z,w)$ Darstellung:
    \begin{figure}[htb!]
        \centering
        \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-03-z-w-darstellung.png}
    \end{figure}
\end{itemize}
\newpage
...
\begin{figure}[htb!]
    \centering
    \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-04-example.png}
\end{figure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-05-small-grafiks.png}
\end{figure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[height=2.5cm]{chapters/mm2-01/mm2-01-06-exponentialfunktion und polararstellung.png}
\end{figure}

$z = (a,b) = a + ib = \sqrt{a^2+b^2}\cdot(\cos(\alpha), \sin(\alpha)) = |z|\exp(i\alpha)$ wobei $\alpha := \arg(z)$ das "Argument" von $z$ ist.

\paragraph{Exponentialfunktion:} $e^w\cdot e^z = w^{w\cdot z}$ für $w,z \in \mathbb{C}$ auch: $e^{i\alpha}\cdot e^{i\beta} = e^{i(\alpha + \beta)}$ für $\alpha, \beta \in \mathbb{R}$

Damit: $e^z = e^{x+iy} = e^x\cdot e^{iy} = e^z \cdot(\cos(y) + i \sin(y))$ mit $|e^z| = e^x$ und $ = \arg(e^z)$

(Beweis für $e^w\dot e^z = e^{w+z}$: siehe Lehrbücher)

\paragraph{Produkt:}$z \cdot w=|z|\cdot|w|\cdot e^{i(\alpha + \beta)}$ für $z:=|z|\cdot e^{i\alpha}$ und $w:=|w|\cdot e^{i\beta}$

-> Interpretation: Drehung um $\beta$ und Streckung um $|w|$ von $z$ .

(Achtung: in der Regel ist $z\cdot w \in \mathbb{C} \implies$ \underline{kein} "Skalarprodukt"!)